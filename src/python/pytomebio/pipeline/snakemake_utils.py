...
def str_from_config(config: Dict[str, Any], key: str) -> str:
    """Gets a string value from the snakemake config object"""
...
def path_from_config(config: Dict[str, Any], key: str) -> Path:
    """Gets a Path value from the snakemake config object"""
    return Path(str_from_config(config, key))
